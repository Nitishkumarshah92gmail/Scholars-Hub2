  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      ...
      <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-[#09090b]/10 backdrop-blur-[2px]"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#1e1e24] via-[#1e1e24]/20 to-transparent"></div>
      </div>
